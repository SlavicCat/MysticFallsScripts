...
local Ban = Rep.Events.Ban
local BanClient = Rep.Events.BanClient
local ModBan = Rep.Events.ModBan
ModBan:Destroy()
BanClient:Destroy()
Ban:Destroy()
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "SlavicCat";
    Text = "Cracked by the Russian cats.";
} )


local library = loadstring(game:HttpGet("https://pastebin.com/raw/XDd6j0Fa"))();

local Spell = library:CreateSection("Spells");
local Other = library:CreateSection("Other");
local Emergency = library:CreateSection("Emergency");

Spell:Button("Delfan KeyBind (J)", function()
...
local A_1 = "delfan"
local A_2 = mouse.Target.Parent.Parent
local A_3 = RootPart
local A_4 = Humanoid
local A_5 = CFrame.new(261.415894, 9.76163769, -216.64386, 0.326493859, -0.32701093, 0.886828959, 7.45058149e-09, 0.938245535, 0.345970303, -0.94519943, -0.112957172, 0.306331366)
local Event = game:GetService("ReplicatedStorage").REMOTES.Spell
...
Spell:Button("Ad Somnum KeyBind (V)", function()
local Player = game.Players.LocalPlayer
local Character = Player.Character
local RootPart = Character.HumanoidRootPart
local Head = Character.Head
...
Spell:Button("Instant Revive KeyBind (M)", function()
...
Spell:Button("Bomba KeyBind (Y)", function()
...
local A_3 = RootPart
local A_4 = Humanoid
local A_5 = CFrame.new(Mouse.Hit.p)
local Event = game:GetService("ReplicatedStorage").REMOTES.Spell
Event:FireServer(A_1, A_2, A_3, A_4, A_5)
...
Spell:Button("Invisible KeyBind (B)", function()
...
local A_3 = RootPart
local A_4 = Humanoid
local A_5 = CFrame.new(-9.97527599, 21.3900642, -166.868576, -0.798369288, 0.16003786, -0.580512166, -1.49011612e-08, 0.964036644, 0.265769422, 0.602168143, 0.212182164, -0.769657254)
local Event = game:GetService("ReplicatedStorage").REMOTES.Spell
Event:FireServer(A_1, A_2, A_3, A_4, A_5)
...
Spell:Button("Mystique KeyBind (E)", function()
local Player = game.Players.LocalPlayer
local Character = Player.Character
local RootPart = Character.HumanoidRootPart
local Head = Character.Head
...
Spell:Button("Bulla KeyBind (U)", function()
...
Other:Button("Self Channel", function()
for i = 1, 6, 1 do
...
local A_1 = "Accept"
local Event = game:GetService("ReplicatedStorage").REMOTES.Channel
Event:FireServer(A_1)

wait(0.5)

local a = Character:WaitForChild("Channel")
a:Destroy()
...
Other:Button("Self Feed (Dont spam. wait 5 sec)", function()
local Player = game.Players.LocalPlayer
local Character = Player.Character
local RootPart = Character.HumanoidRootPart
local Head = Character.Head
...
if Character.Thirst.Thirsty == 1 then

local A_1 = "feed"
local A_2 = Humanoid
local A_3 = Character
local A_4 = Head
local Event = game:GetService("ReplicatedStorage").REMOTES.Key
...
Other:Button("Make yourself be able to merge again", function()
local Player = game.Players.LocalPlayer
local Character = Player.Character
local RootPart = Character.HumanoidRootPart
local Head = Character.Head
local Humanoid = Character.Humanoid
local Merged = Character:WaitForChild("Merged")

Merged:Destroy()

end)
Other:Button("Admin Cmds", function()
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "Reviz Admin V2 by BekacPros";
})
wait(0.1)
...
Emergency:Button("Heal", function()
...
local A_2 = Humanoid
local A_3 = Character
local A_4 = mouse.Target.Parent.Parent
local Event = game:GetService("ReplicatedStorage").REMOTES.Key
Event:FireServer(A_1, A_2, A_3, A_4)
...
Emergency:Button("Choke", function()
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "Made by BekacPros                        Credits to Qonscious"
})
local UIS = game:GetService("UserInputService")

UIS.InputBegan:Connect(function(input, gameProcessedEvent)
	if (input.KeyCode == Enum.KeyCode.F4 and UIS:IsKeyDown(Enum.KeyCode.F3)) then
		local a = game.CoreGui.ScreenGui
